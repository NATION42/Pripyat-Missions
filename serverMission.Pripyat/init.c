void main()
{
	...
	//GetCEApi().ExportProxyData("10240 0 10240", 14500);	// dont use it at Pripyat atm // standard map groups (buildings) export, terrain center and radius needs to be specified
